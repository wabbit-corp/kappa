...
- [ ] Implement the M3 diagnostic-origin contract: dropped owned resources use the unconsumed binder as primary origin; overuse uses the second consuming site as primary with the first consume and binder as related origins; borrow escape uses the escape site as primary with the borrow introduction and captured binding as related origins.
