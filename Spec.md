...
For portable v1 termination certificates, the arithmetic solver used by §6.4.2E may discharge only quantifier-free
linear arithmetic obligations over `Nat` expressions generated by primitive measures.
